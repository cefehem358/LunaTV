...
export const changelog: ChangelogEntry[] = [
  {
    ...
    fixed: [
      '徹底解決跨季與外傳片源誤配問題：為 `isFuzzyMatch` 新增基於淨化標題長度差異（cName 與 cQuery）的過濾機制，精準阻斷「第四季」匹配到無季數的「蒼海之淚篇」等外傳',
      '增強季數識別能力（extractSeasonNumber）：新增支援尾部羅馬數字（II ~ X）與尾部空格/橫線數字（如「 4」或「-4」）的季數提取',
    ],
  },
  {
    version: '1.6.3',
